import{p as F,bN as C,q as h,s as e,a8 as H,v as M,x as L,z as W,A as G,d as E,bk as q,n as l,b2 as J,bO as K,I as Q,J as N,O as U,m as T,bn as X,as as j}from"./index-DCBkkiSD.js";function _(t,c="default",p=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const n=i[c];if(typeof n=="function")return n()}return p}const Y={thPaddingBorderedSmall:"8px 12px",thPaddingBorderedMedium:"12px 16px",thPaddingBorderedLarge:"16px 24px",thPaddingSmall:"0",thPaddingMedium:"0",thPaddingLarge:"0",tdPaddingBorderedSmall:"8px 12px",tdPaddingBorderedMedium:"12px 16px",tdPaddingBorderedLarge:"16px 24px",tdPaddingSmall:"0 0 8px 0",tdPaddingMedium:"0 0 12px 0",tdPaddingLarge:"0 0 16px 0"};function Z(t){const{tableHeaderColor:c,textColor2:p,textColor1:i,cardColor:n,modalColor:b,popoverColor:m,dividerColor:a,borderRadius:s,fontWeightStrong:d,lineHeight:S,fontSizeSmall:r,fontSizeMedium:v,fontSizeLarge:u}=t;return Object.assign(Object.assign({},Y),{lineHeight:S,fontSizeSmall:r,fontSizeMedium:v,fontSizeLarge:u,titleTextColor:i,thColor:C(n,c),thColorModal:C(b,c),thColorPopover:C(m,c),thTextColor:i,thFontWeight:d,tdTextColor:p,tdColor:n,tdColorModal:b,tdColorPopover:m,borderColor:C(n,a),borderColorModal:C(b,a),borderColorPopover:C(m,a),borderRadius:s})}const ee={common:F,self:Z},oe=h([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
 ...
 `))]),V="DESCRIPTION_ITEM_FLAG";function re(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[V]:!1}const te=Object.assign(Object.assign({},N.props),{title:String,column:{type:Number,default:3},columns:Number,labelPlacement:{type:String,default:"top"},labelAlign:{type:String,default:"left"},separator:{type:String,default:":"},size:String,bordered:Boolean,labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]}),ie=E({name:"Descriptions",props:te,slots:Object,setup(t){const{mergedClsPrefixRef:c,inlineThemeDisabled:p,mergedComponentPropsRef:i}=Q(t),n=T(()=>{var s,d;return t.size||((d=(s=i==null?void 0:i.value)===null||s===void 0?void 0:s.Descriptions)===null||d===void 0?void 0:d.size)||"medium"}),b=N("Descriptions","-descriptions",oe,ee,t,c),m=T(()=>{const{bordered:s}=t,d=n.value,{common:{cubicBezierEaseInOut:S},self:{titleTextColor:r,thColor:v,thColorModal:u,thColorPopover:O,thTextColor:B,thFontWeight:k,tdTextColor:A,tdColor:o,tdColorModal:y,tdColorPopover:I,borderColor:g,borderColorModal:f,borderColorPopover:w,borderRadius:z,lineHeight:x,[j("fontSize",d)]:P,[j(s?"thPaddingBordered":"thPadding",d)]:$,[j(s?"tdPaddingBordered":"tdPadding",d)]:R}}=b.value;return{"--n-title-text-color":r,"--n-th-padding":$,"--n-td-padding":R,"--n-font-size":P,"--n-bezier":S,"--n-th-font-weight":k,"--n-line-height":x,"--n-th-text-color":B,"--n-td-text-color":A,"--n-th-color":v,"--n-th-color-modal":u,"--n-th-color-popover":O,"--n-td-color":o,"--n-td-color-modal":y,"--n-td-color-popover":I,"--n-border-radius":z,"--n-border-color":g,"--n-border-color-modal":f,"--n-border-color-popover":w}}),a=p?U("descriptions",T(()=>{let s="";const{bordered:d}=t;return d&&(s+="a"),s+=n.value[0],s}),m,t):void 0;return{mergedClsPrefix:c,cssVars:p?void 0:m,themeClass:a==null?void 0:a.themeClass,onRender:a==null?void 0:a.onRender,compitableColumn:X(t,["columns","column"]),inlineThemeDisabled:p,mergedSize:n}},render(){const t=this.$slots.default,c=t?q(t()):[];c.length;const{contentClass:p,labelClass:i,compitableColumn:n,labelPlacement:b,labelAlign:m,mergedSize:a,bordered:s,title:d,cssVars:S,mergedClsPrefix:r,separator:v,onRender:u}=this;u==null||u();const O=c.filter(o=>re(o)),B={span:0,row:[],secondRow:[],rows:[]},A=O.reduce((o,y,I)=>{const g=y.props||{},f=O.length-1===I,w=["label"in g?g.label:_(y,"label")],z=[_(y)],x=g.span||1,P=o.span;o.span+=x;const $=g.labelStyle||g["label-style"]||this.labelStyle,R=g.contentStyle||g["content-style"]||this.contentStyle;if(b==="left")s?o.row.push(l("th",{class:[`${r}-descriptions-table-header`,i],colspan:1,style:$},w),l("td",{class:[`${r}-descriptions-table-content`,p],colspan:f?(n-P)*2+1:x*2-1,style:R},z)):o.row.push(l("td",{class:`${r}-descriptions-table-content`,colspan:f?(n-P)*2:x*2},l("span",{class:[`${r}-descriptions-table-content__label`,i],style:$},[...w,v&&l("span",{class:`${r}-descriptions-separator`},v)]),l("span",{class:[`${r}-descriptions-table-content__content`,p],style:R},z)));else{const D=f?(n-P)*2:x*2;o.row.push(l("th",{class:[`${r}-descriptions-table-header`,i],colspan:D,style:$},w)),o.secondRow.push(l("td",{class:[`${r}-descriptions-table-content`,p],colspan:D,style:R},z))}return(o.span>=n||f)&&(o.span=0,o.row.length&&(o.rows.push(o.row),o.row=[]),b!=="left"&&o.secondRow.length&&(o.rows.push(o.secondRow),o.secondRow=[])),o},B).rows.map(o=>l("tr",{class:`${r}-descriptions-table-row`},o));return l("div",{style:S,class:[`${r}-descriptions`,this.themeClass,`${r}-descriptions--${b}-label-placement`,`${r}-descriptions--${m}-label-align`,`${r}-descriptions--${a}-size`,s&&`${r}-descriptions--bordered`]},d||this.$slots.header?l("div",{class:`${r}-descriptions-header`},d||K(this,"header")):null,l("div",{class:`${r}-descriptions-table-wrapper`},l("table",{class:`${r}-descriptions-table`},l("tbody",null,b==="top"&&l("tr",{class:`${r}-descriptions-table-row`,style:{visibility:"collapse"}},J(n*2,l("td",null))),A))))}}),ne={label:String,span:{type:Number,default:1},labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]},se=E({name:"DescriptionsItem",[V]:!0,props:ne,slots:Object,render(){return null}});export{se as N,ie as a};

import{p as S,q as h,s as p,a7 as C,v as f,d as x,n as r,ba as T,T as $,I as k,J as v,O as w,m,al as O,r as R,bn as j,bV as B,b3 as N,as as P}from"./index-DCBkkiSD.js";function V(e){const{opacityDisabled:a,heightTiny:t,heightSmall:s,heightMedium:l,heightLarge:n,heightHuge:c,primaryColor:o,fontSize:i}=e;return{fontSize:i,textColor:o,sizeTiny:t,sizeSmall:s,sizeMedium:l,sizeLarge:n,sizeHuge:c,color:o,opacitySpinning:a}}const I={common:S,self:V},L=h([h("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {

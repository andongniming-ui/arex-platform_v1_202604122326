import{ag as ae,m as S,aH as ce,d as A,n as C,p as le,q as P,s as j,v as R,x as b,I as Y,o as ne,w as J,J as W,M as oe,r as D,U as M,au as ue,aa as me,L as fe,aC as se,a8 as he,ak as pe,P as F,aw as ge,ad as ve,af as xe,aI as be,aJ as Q,ab as Ce,aK as we,aL as ye,aj as $e,az as Ne,al as _e,aM as ee,W as B,e as h,u,N as je,Y as H,X as Re,b as g,l as N,t as T,k as te,c as Se,Z as ze,F as Ee,B as re,h as Pe,i as k}from"./index-By7nBA3K.js";import{r as K}from"./recordings-BGVSx0gr.js";import{f as Ie}from"./time-DBiNR5Lf.js";import{N as Z}from"./Divider-D9YTe3Vt.js";import{u as Te}from"./use-message-Pmc6Kr4V.js";import{N as E,a as ke}from"./DescriptionsItem-Bpma9Pxg.js";import{N as De}from"./DynamicTags-DtQYEAL1.js";import{N as Ae}from"./Tag-jBJuUJOE.js";import"./client-DofY_RJ9.js";import"./Input-B2P9R1ZR.js";import"./Add-BuYEuuYZ.js";function Le(t,e){const s=ae(ce,null);return S(()=>t.hljs||(s==null?void 0:s.mergedHljsRef.value))}const Be=A({name:"ChevronLeft",render(){return C("svg",{viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},C("path",{d:"M10.3536 3.14645C10.5488 3.34171 10.5488 3.65829 10.3536 3.85355L6.20711 8L10.3536 12.1464C10.5488 12.3417 10.5488 12.6583 10.3536 12.8536C10.1583 13.0488 9.84171 13.0488 9.64645 12.8536L5.14645 8.35355C4.95118 8.15829 4.95118 7.84171 5.14645 7.64645L9.64645 3.14645C9.84171 2.95118 10.1583 2.95118 10.3536 3.14645Z",fill:"currentColor"}))}});function Fe(t){const{textColor2:e,fontSize:s,fontWeightStrong:i,textColor3:r}=t;return{textColor:e,fontSize:s,fontWeightStrong:i,"mono-3":"#a0a1a7","hue-1":"#0184bb","hue-2":"#4078f2","hue-3":"#a626a4","hue-4":"#50a14f","hue-5":"#e45649","hue-5-2":"#c91243","hue-6":"#986801","hue-6-2":"#c18401",lineNumberTextColor:r}}const He={common:le,self:Fe},Me=P([j("code",`
 ...
 }`]}]),We=Object.assign(Object.assign({},W.props),{language:String,code:{type:String,default:""},trim:{type:Boolean,default:!0},hljs:Object,uri:Boolean,inline:Boolean,wordWrap:Boolean,showLineNumbers:Boolean,internalFontSize:Number,internalNoHighlight:Boolean}),X=A({name:"Code",props:We,setup(t,{slots:e}){const{internalNoHighlight:s}=t,{mergedClsPrefixRef:i,inlineThemeDisabled:r}=Y(),n=D(null),p=s?{value:void 0}:Le(t),w=(d,f,c)=>{const{value:o}=p;return!o||!(d&&o.getLanguage(d))?null:o.highlight(c?f.trim():f,{language:d}).value},_=S(()=>t.inline||t.wordWrap?!1:t.showLineNumbers),v=()=>{if(e.default)return;const{value:d}=n;if(!d)return;const{language:f}=t,c=t.uri?window.decodeURIComponent(t.code):t.code;if(f){const m=w(f,c,t.trim);if(m!==null){if(t.inline)d.innerHTML=m;else{const x=d.querySelector(".__code__");x&&d.removeChild(x);const $=document.createElement("pre");$.className="__code__",$.innerHTML=m,d.appendChild($)}return}}if(t.inline){d.textContent=c;return}const o=d.querySelector(".__code__");if(o)o.textContent=c;else{const m=document.createElement("pre");m.className="__code__",m.textContent=c,d.innerHTML="",d.appendChild(m)}};ne(v),J(M(t,"language"),v),J(M(t,"code"),v),s||J(p,v);const y=W("Code","-code",Me,He,t,i),l=S(()=>{const{common:{cubicBezierEaseInOut:d,fontFamilyMono:f},self:{textColor:c,fontSize:o,fontWeightStrong:m,lineNumberTextColor:x,"mono-3":$,"hue-1":z,"hue-2":I,"hue-3":L,"hue-4":O,"hue-5":U,"hue-5-2":V,"hue-6":q,"hue-6-2":de}}=y.value,{internalFontSize:G}=t;return{"--n-font-size":G?`${G}px`:o,"--n-font-family":f,"--n-font-weight-strong":m,"--n-bezier":d,"--n-text-color":c,"--n-mono-3":$,"--n-hue-1":z,"--n-hue-2":I,"--n-hue-3":L,"--n-hue-4":O,"--n-hue-5":U,"--n-hue-5-2":V,"--n-hue-6":q,"--n-hue-6-2":de,"--n-line-number-text-color":x}}),a=r?oe("code",S(()=>`${t.internalFontSize||"a"}`),l,t):void 0;return{mergedClsPrefix:i,codeRef:n,mergedShowLineNumbers:_,lineNumbers:S(()=>{let d=1;const f=[];let c=!1;for(const o of t.code)o===`
